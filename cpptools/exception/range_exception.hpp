#ifndef CPPTOOLS_EXCEPTION_RANGE_EXCEPTION_HPP
#define CPPTOOLS_EXCEPTION_RANGE_EXCEPTION_HPP
...
public:
    ...
    CPPTOOLS_API range_exception(std::pair<size_t, size_t> expected_range, size_t value);
...
#endif//CPPTOOLS_EXCEPTION_RANGE_EXCEPTION_HPP